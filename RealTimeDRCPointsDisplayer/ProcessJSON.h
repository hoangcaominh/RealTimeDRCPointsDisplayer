...
bool Load_wrs()
{
	...
	// HRtP world records
	_HRtP.wr.easy.Jigoku = j["HRtP"]["Easy"]["Jigoku"][0].get<ul>();
	_HRtP.wr.easy.Makai = j["HRtP"]["Easy"]["Makai"][0].get<ul>();
	_HRtP.wr.normal.Jigoku = j["HRtP"]["Normal"]["Jigoku"][0].get<ul>();
	_HRtP.wr.normal.Makai = j["HRtP"]["Normal"]["Makai"][0].get<ul>();
	_HRtP.wr.hard.Jigoku = j["HRtP"]["Hard"]["Jigoku"][0].get<ul>();
	_HRtP.wr.hard.Makai = j["HRtP"]["Hard"]["Makai"][0].get<ul>();
	_HRtP.wr.lunatic.Jigoku = j["HRtP"]["Lunatic"]["Jigoku"][0].get<ul>();
	_HRtP.wr.lunatic.Makai = j["HRtP"]["Lunatic"]["Makai"][0].get<ul>();

	// SoEW world records
	_SoEW.wr.easy.ReimuA = j["SoEW"]["Easy"]["ReimuA"][0].get<ul>();
	_SoEW.wr.easy.ReimuB = j["SoEW"]["Easy"]["ReimuB"][0].get<ul>();
	_SoEW.wr.easy.ReimuC = j["SoEW"]["Easy"]["ReimuC"][0].get<ul>();
	_SoEW.wr.normal.ReimuA = j["SoEW"]["Normal"]["ReimuA"][0].get<ul>();
	_SoEW.wr.normal.ReimuB = j["SoEW"]["Normal"]["ReimuB"][0].get<ul>();
	_SoEW.wr.normal.ReimuC = j["SoEW"]["Normal"]["ReimuC"][0].get<ul>();
	_SoEW.wr.hard.ReimuA = j["SoEW"]["Hard"]["ReimuA"][0].get<ul>();
	_SoEW.wr.hard.ReimuB = j["SoEW"]["Hard"]["ReimuB"][0].get<ul>();
	_SoEW.wr.hard.ReimuC = j["SoEW"]["Hard"]["ReimuC"][0].get<ul>();
	_SoEW.wr.lunatic.ReimuA = j["SoEW"]["Lunatic"]["ReimuA"][0].get<ul>();
	_SoEW.wr.lunatic.ReimuB = j["SoEW"]["Lunatic"]["ReimuB"][0].get<ul>();
	_SoEW.wr.lunatic.ReimuC = j["SoEW"]["Lunatic"]["ReimuC"][0].get<ul>();
	_SoEW.wr.extra.ReimuA = j["SoEW"]["Extra"]["ReimuA"][0].get<ul>();
	_SoEW.wr.extra.ReimuB = j["SoEW"]["Extra"]["ReimuB"][0].get<ul>();
	_SoEW.wr.extra.ReimuC = j["SoEW"]["Extra"]["ReimuC"][0].get<ul>();

	// PoDD world records
	_PoDD.wr.easy.Reimu = j["PoDD"]["Easy"]["Reimu"][0].get<ul>();
	_PoDD.wr.easy.Mima = j["PoDD"]["Easy"]["Mima"][0].get<ul>();
	_PoDD.wr.easy.Marisa = j["PoDD"]["Easy"]["Marisa"][0].get<ul>();
	_PoDD.wr.easy.Ellen = j["PoDD"]["Easy"]["Ellen"][0].get<ul>();
	_PoDD.wr.easy.Kotohime = j["PoDD"]["Easy"]["Kotohime"][0].get<ul>();
	_PoDD.wr.easy.Kana = j["PoDD"]["Easy"]["Kana"][0].get<ul>();
	_PoDD.wr.easy.Rikako = j["PoDD"]["Easy"]["Rikako"][0].get<ul>();
	_PoDD.wr.easy.Chiyuri = j["PoDD"]["Easy"]["Chiyuri"][0].get<ul>();
	_PoDD.wr.easy.Yumemi = j["PoDD"]["Easy"]["Yumemi"][0].get<ul>();
	_PoDD.wr.normal.Reimu = j["PoDD"]["Normal"]["Reimu"][0].get<ul>();
	_PoDD.wr.normal.Mima = j["PoDD"]["Normal"]["Mima"][0].get<ul>();
	_PoDD.wr.normal.Marisa = j["PoDD"]["Normal"]["Marisa"][0].get<ul>();
	_PoDD.wr.normal.Ellen = j["PoDD"]["Normal"]["Ellen"][0].get<ul>();
	_PoDD.wr.normal.Kotohime = j["PoDD"]["Normal"]["Kotohime"][0].get<ul>();
	_PoDD.wr.normal.Kana = j["PoDD"]["Normal"]["Kana"][0].get<ul>();
	_PoDD.wr.normal.Rikako = j["PoDD"]["Normal"]["Rikako"][0].get<ul>();
	_PoDD.wr.normal.Chiyuri = j["PoDD"]["Normal"]["Chiyuri"][0].get<ul>();
	_PoDD.wr.normal.Yumemi = j["PoDD"]["Normal"]["Yumemi"][0].get<ul>();
	_PoDD.wr.hard.Reimu = j["PoDD"]["Hard"]["Reimu"][0].get<ul>();
	_PoDD.wr.hard.Mima = j["PoDD"]["Hard"]["Mima"][0].get<ul>();
	_PoDD.wr.hard.Marisa = j["PoDD"]["Hard"]["Marisa"][0].get<ul>();
	_PoDD.wr.hard.Ellen = j["PoDD"]["Hard"]["Ellen"][0].get<ul>();
	_PoDD.wr.hard.Kotohime = j["PoDD"]["Hard"]["Kotohime"][0].get<ul>();
	_PoDD.wr.hard.Kana = j["PoDD"]["Hard"]["Kana"][0].get<ul>();
	_PoDD.wr.hard.Rikako = j["PoDD"]["Hard"]["Rikako"][0].get<ul>();
	_PoDD.wr.hard.Chiyuri = j["PoDD"]["Hard"]["Chiyuri"][0].get<ul>();
	_PoDD.wr.hard.Yumemi = j["PoDD"]["Hard"]["Yumemi"][0].get<ul>();
	_PoDD.wr.lunatic.Reimu = j["PoDD"]["Lunatic"]["Reimu"][0].get<ul>();
	_PoDD.wr.lunatic.Mima = j["PoDD"]["Lunatic"]["Mima"][0].get<ul>();
	_PoDD.wr.lunatic.Marisa = j["PoDD"]["Lunatic"]["Marisa"][0].get<ul>();
	_PoDD.wr.lunatic.Ellen = j["PoDD"]["Lunatic"]["Ellen"][0].get<ul>();
	_PoDD.wr.lunatic.Kotohime = j["PoDD"]["Lunatic"]["Kotohime"][0].get<ul>();
	_PoDD.wr.lunatic.Kana = j["PoDD"]["Lunatic"]["Kana"][0].get<ul>();
	_PoDD.wr.lunatic.Rikako = j["PoDD"]["Lunatic"]["Rikako"][0].get<ul>();
	_PoDD.wr.lunatic.Chiyuri = j["PoDD"]["Lunatic"]["Chiyuri"][0].get<ul>();
	_PoDD.wr.lunatic.Yumemi = j["PoDD"]["Lunatic"]["Yumemi"][0].get<ul>();

	// LLS world records
	_LLS.wr.easy.ReimuA = j["LLS"]["Easy"]["ReimuA"][0].get<ul>();
	_LLS.wr.easy.ReimuB = j["LLS"]["Easy"]["ReimuB"][0].get<ul>();
	_LLS.wr.easy.MarisaA = j["LLS"]["Easy"]["MarisaA"][0].get<ul>();
	_LLS.wr.easy.MarisaB = j["LLS"]["Easy"]["MarisaB"][0].get<ul>();
	_LLS.wr.normal.ReimuA = j["LLS"]["Normal"]["ReimuA"][0].get<ul>();
	_LLS.wr.normal.ReimuB = j["LLS"]["Normal"]["ReimuB"][0].get<ul>();
	_LLS.wr.normal.MarisaA = j["LLS"]["Normal"]["MarisaA"][0].get<ul>();
	_LLS.wr.normal.MarisaB = j["LLS"]["Normal"]["MarisaB"][0].get<ul>();
	_LLS.wr.hard.ReimuA = j["LLS"]["Hard"]["ReimuA"][0].get<ul>();
	_LLS.wr.hard.ReimuB = j["LLS"]["Hard"]["ReimuB"][0].get<ul>();
	_LLS.wr.hard.MarisaA = j["LLS"]["Hard"]["MarisaA"][0].get<ul>();
	_LLS.wr.hard.MarisaB = j["LLS"]["Hard"]["MarisaB"][0].get<ul>();
	_LLS.wr.lunatic.ReimuA = j["LLS"]["Lunatic"]["ReimuA"][0].get<ul>();
	_LLS.wr.lunatic.ReimuB = j["LLS"]["Lunatic"]["ReimuB"][0].get<ul>();
	_LLS.wr.lunatic.MarisaA = j["LLS"]["Lunatic"]["MarisaA"][0].get<ul>();
	_LLS.wr.lunatic.MarisaB = j["LLS"]["Lunatic"]["MarisaB"][0].get<ul>();
	_LLS.wr.extra.ReimuA = j["LLS"]["Extra"]["ReimuA"][0].get<ul>();
	_LLS.wr.extra.ReimuB = j["LLS"]["Extra"]["ReimuB"][0].get<ul>();
	_LLS.wr.extra.MarisaA = j["LLS"]["Extra"]["MarisaA"][0].get<ul>();
	_LLS.wr.extra.MarisaB = j["LLS"]["Extra"]["MarisaB"][0].get<ul>();

	// MS world record
	_MS.wr.easy.Reimu = j["MS"]["Easy"]["Reimu"][0].get<ul>();
	_MS.wr.easy.Marisa = j["MS"]["Easy"]["Marisa"][0].get<ul>();
	_MS.wr.easy.Mima = j["MS"]["Easy"]["Mima"][0].get<ul>();
	_MS.wr.easy.Yuuka = j["MS"]["Easy"]["Yuuka"][0].get<ul>();
	_MS.wr.normal.Reimu = j["MS"]["Normal"]["Reimu"][0].get<ul>();
	_MS.wr.normal.Marisa = j["MS"]["Normal"]["Marisa"][0].get<ul>();
	_MS.wr.normal.Mima = j["MS"]["Normal"]["Mima"][0].get<ul>();
	_MS.wr.normal.Yuuka = j["MS"]["Normal"]["Yuuka"][0].get<ul>();
	_MS.wr.hard.Reimu = j["MS"]["Hard"]["Reimu"][0].get<ul>();
	_MS.wr.hard.Marisa = j["MS"]["Hard"]["Marisa"][0].get<ul>();
	_MS.wr.hard.Mima = j["MS"]["Hard"]["Mima"][0].get<ul>();
	_MS.wr.hard.Yuuka = j["MS"]["Hard"]["Yuuka"][0].get<ul>();
	_MS.wr.lunatic.Reimu = j["MS"]["Lunatic"]["Reimu"][0].get<ul>();
	_MS.wr.lunatic.Marisa = j["MS"]["Lunatic"]["Marisa"][0].get<ul>();
	_MS.wr.lunatic.Mima = j["MS"]["Lunatic"]["Mima"][0].get<ul>();
	_MS.wr.lunatic.Yuuka = j["MS"]["Lunatic"]["Yuuka"][0].get<ul>();
	_MS.wr.extra.Reimu = j["MS"]["Extra"]["Reimu"][0].get<ul>();
	_MS.wr.extra.Marisa = j["MS"]["Extra"]["Marisa"][0].get<ul>();
	_MS.wr.extra.Mima = j["MS"]["Extra"]["Mima"][0].get<ul>();
	_MS.wr.extra.Yuuka = j["MS"]["Extra"]["Yuuka"][0].get<ul>();

	// EoSD world record
	_EoSD.wr.easy.ReimuA = j["EoSD"]["Easy"]["ReimuA"][0].get<ull>();
	_EoSD.wr.easy.ReimuB = j["EoSD"]["Easy"]["ReimuB"][0].get<ull>();
	_EoSD.wr.easy.MarisaA = j["EoSD"]["Easy"]["MarisaA"][0].get<ull>();
	_EoSD.wr.easy.MarisaB = j["EoSD"]["Easy"]["MarisaB"][0].get<ull>();
	_EoSD.wr.normal.ReimuA = j["EoSD"]["Normal"]["ReimuA"][0].get<ull>();
	_EoSD.wr.normal.ReimuB = j["EoSD"]["Normal"]["ReimuB"][0].get<ull>();
	_EoSD.wr.normal.MarisaA = j["EoSD"]["Normal"]["MarisaA"][0].get<ull>();
	_EoSD.wr.normal.MarisaB = j["EoSD"]["Normal"]["MarisaB"][0].get<ull>();
	_EoSD.wr.hard.ReimuA = j["EoSD"]["Hard"]["ReimuA"][0].get<ull>();
	_EoSD.wr.hard.ReimuB = j["EoSD"]["Hard"]["ReimuB"][0].get<ull>();
	_EoSD.wr.hard.MarisaA = j["EoSD"]["Hard"]["MarisaA"][0].get<ull>();
	_EoSD.wr.hard.MarisaB = j["EoSD"]["Hard"]["MarisaB"][0].get<ull>();
	_EoSD.wr.lunatic.ReimuA = j["EoSD"]["Lunatic"]["ReimuA"][0].get<ull>();
	_EoSD.wr.lunatic.ReimuB = j["EoSD"]["Lunatic"]["ReimuB"][0].get<ull>();
	_EoSD.wr.lunatic.MarisaA = j["EoSD"]["Lunatic"]["MarisaA"][0].get<ull>();
	_EoSD.wr.lunatic.MarisaB = j["EoSD"]["Lunatic"]["MarisaB"][0].get<ull>();
	_EoSD.wr.extra.ReimuA = j["EoSD"]["Extra"]["ReimuA"][0].get<ull>();
	_EoSD.wr.extra.ReimuB = j["EoSD"]["Extra"]["ReimuB"][0].get<ull>();
	_EoSD.wr.extra.MarisaA = j["EoSD"]["Extra"]["MarisaA"][0].get<ull>();
	_EoSD.wr.extra.MarisaB = j["EoSD"]["Extra"]["MarisaB"][0].get<ull>();
